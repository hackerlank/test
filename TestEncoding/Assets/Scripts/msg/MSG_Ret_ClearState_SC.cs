namespace msg
{
    ...
    [Serializable, ProtoContract(Name="MSG_Ret_ClearState_SC")]
    public class MSG_Ret_ClearState_SC : IExtensible
    {
        ...
        [DefaultValue((long) 0L), ProtoMember(1, IsRequired=false, Name="type", DataFormat=DataFormat.TwosComplement)]
        public uint type
        {
            get
            {
